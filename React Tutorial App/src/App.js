...
import UseReducerCounter1 from "./Hooks/UseReducerCounter1";
import ComplexUseReducerCounter from "./Hooks/ComplexUseReducerCounter";
import MultipleUseReducerCounter from "./Hooks/MultipleUseReducerCounter";
  ...
  render() {
    return (
      ...
      <Welcome_Nipun /> {/*Using the named export to render the data from the file Welcome.js */}
        ...
        {/* <Counter2 /> */}
        {/* <UseReducerCounter1 /> */}
        {/* <ComplexUseReducerCounter /> */}
        {/* <MultipleUseReducerCounter /> */}
      </div>
    );
  }
}
