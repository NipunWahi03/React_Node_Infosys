...
class EventBinding extends Component{
    ...
    render(){
        return(
            ...
            {/* <button onClick={()=>this.clickHandler()}> Click to change the Event Handler</button> Using 2nd approact for event binding i.e using arrow function */}
            <button onClick={this.clickHandler}> Click to change the Event Handler</button> {/*Using 3rd approact for event binding i.e doing binding in constructor rather than in render() method*/}
            </div>
        )
    }
}
